...
class AddShippedActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_shipped)
    ...
    private fun AddShipped() {
        RetrofitClient.instance.AddBarangKeluar(
            EdTgl.text.toString(),
            ...
            override fun onFailure(call: Call<ModelResponse>, t: Throwable) {
                Toast.makeText(this@AddShippedActivity, "Maaf Sistem Sedang Gangguan", Toast.LENGTH_SHORT).show()
            ...
            override fun onResponse(call: Call<ModelResponse>, response: Response<ModelResponse>) {
                if (response.isSuccessful){
                    if (response.body()!!.status == "true") {
                        AlertDialog.Builder(this@AddShippedActivity)
                            .setTitle("Tambah Data?")
                            .setPositiveButton(
                                "Ya",
                                DialogInterface.OnClickListener { dialog, which ->
                                    Toast.makeText(
                                        this@AddShippedActivity,
                                        "Berhasil",
                                        Toast.LENGTH_SHORT
                                    ).show()
                                    startActivity(
                        ...
                        Toast.makeText(this@AddShippedActivity, response.body()!!.message, Toast.LENGTH_SHORT).show()
                    }
                }else{
                    Toast.makeText(this@AddShippedActivity, "Kesalahan", Toast.LENGTH_SHORT).show()
                }
            }
